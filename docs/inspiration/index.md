...
You can use all hardware listed on the [Components](../components/) page. Feel free to combine and experiment with any parts you like!
...
- [Capacitive Piano](./capacitive-piano)
- [Energy Production](./energy-production)
- [More Ideas](./more-ideas) (short thought-starters)
